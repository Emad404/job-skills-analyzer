...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-8 h-8 rounded-md flex items-center justify-center transition-colors duration-150 focus:outline-none"
      style={{
    ...
    >
      <span className={["absolute transition-all duration-300", isDark ? "opacity-100 rotate-0 scale-100" : "opacity-0 rotate-90 scale-75 pointer-events-none"].join(" ")}>
